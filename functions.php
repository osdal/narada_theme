<?php
/**
 * Narada functions and definitions
 *
 ...
 */
function narada_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Narada, use a find and replace
		* to change 'narada' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'narada', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'narada_setup' );
 ...
 */
function narada_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'narada_content_width', 640 );
}
add_action( 'after_setup_theme', 'narada_content_width', 0 );
 ...
 */
function narada_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'narada' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'narada' ),
...
add_action( 'widgets_init', 'narada_widgets_init' );
